...
import { StrategyOptions, StrategyOptionsWithRequest } from './models/strategyOptions';
/**
 * @public
 */
export declare class Strategy extends OAuth2Strategy {
    ...
    constructor(userOptions: StrategyOptionsWithRequest, verify: VerifyFunctionWithRequest);
    static buildStrategyOptions(userOptions: StrategyOptions | StrategyOptionsWithRequest): {
        authorizationURL: string;
        tokenURL: string;
        passReqToCallback?: false | undefined;
        clientType: "public" | "private" | "confidential";
        clientID: string;
        clientSecret: string;
        ...
        store?: import("passport-oauth2").StateStore | undefined;
        state?: any;
        skipUserProfile?: any;
    ...
    addDefaultScopes(scopes: string[], options: StrategyOptions | StrategyOptionsWithRequest): string[];
}
