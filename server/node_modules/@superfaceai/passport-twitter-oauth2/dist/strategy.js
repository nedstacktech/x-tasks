...
const strategyOptions_1 = require("./models/strategyOptions");
/**
 * @public
 */
class Strategy extends passport_oauth2_1.Strategy {
    constructor(userOptions, verify) {
        ...
        if ((0, strategyOptions_1.isStrategyOptions)(options)) {
            super(options, verify);
        }
        else if ((0, strategyOptions_1.isStrategyOptionsWithRequest)(options)) {
            super(options, verify);
        }
        else {
    ...
    static buildStrategyOptions(userOptions) {
        ...
        return Object.assign(Object.assign({}, options), { authorizationURL,
            tokenURL });
    }
    /**
